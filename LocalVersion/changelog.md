...
- **Markdown Rendering Enhancement**: Integrated marked.js library.
  ...
  - LocalVersion: loads from `js/vendor/marked.min.js`
  - OnlineVersion: loads from CDN
...
### 📁 Files Changed
- `index.html`: Added marked.js reference, Export Report button, data-i18n attributes
...
- `js/vendor/marked.min.js`: **NEW FILE**
